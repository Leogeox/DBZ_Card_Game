...
<body id="body">
    <header class="header">
        <div class="container">
            ...
            <div class="sidenav">
                ...
                <script>
                    // code pour ouvrir/fermer la sidenav
    ...
    <main class="main_bg">
                            ...
                            <div class="content tab1">
                                <h1 class="tab_title">Boosters</h1>
                                    <div class="tabs_container">
                                        ...
                                        <a href="db-booster1.html"><img src="img/boosters/DB Booster 1.png" alt=""></a>
                                        </div>
                                        <div class="inside_tab">
                                            <a href="db-booster2.html"><img src="img/boosters/DB Booster 2.png" alt=""></a>
                                        </div>
                                        <div class="inside_tab">
                                            <a href="db-booster3.html"><img src="img/boosters/DB Booster 3.png" alt=""></a>
                                        </div>
                                    </div>
                                </div>
                            </li>
        ...
        <img class="img" src="img/swiper/dragon.jpg" alt="">
        ...
        <div class="none_trade" id="interaction">
            <h2>Trade Center</h2>
            <form action="">
                <h3> Would like to trade with</h3>
