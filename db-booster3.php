    ...
    <section>
        ...
        <section>
            <div class="openbooster_container">
                ...
                //     if (isset($_POST['boosterBtn'])) {

                //         $timeStart = new DateTime("now");
                //         $timeEnd = new DateTime("tomorrow");

                //         echo $timeStart->format('Y-m-d H:i:s');

                //         $difference = $timeEnd->getTimestamp() - $timeStart->getTimestamp();

                //         if ($difference === 86400) { // 24 hours in seconds
                //             echo "YIPPIE";
                //         } else {
                //             echo "NON";
                //         }
                ...
                ?>-->
                <!-- <form method="POST"> -->
                    <button class="openBtn btnB3" id="boosterBtn" name="boosterBtn">OPEN</button>
                <!-- </form> -->
            </div>
        </section>

        <section class="container containerBottom"> 
