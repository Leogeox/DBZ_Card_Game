    ...
    <main class="main_bg">
        ...
        <section>
            <div class="openbooster_container">
                ...
                <button class="openBtn btnB1">OPEN</button>
            </div>
        </section>
        ...
        <section class="container containerBottom"> <!-- booster -->
            ...
            <script>
                ...
                async function getRandom(count = 5) {
                    ...
                    const min = 20; // carte min
                    const max = 39; // carte max
                    const random = data.items.slice(min, max);
                    // pour avoir une carte random entre le min et le max mit
